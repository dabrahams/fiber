...
class ChannelTests: TestCase {
    ...
    func testChannelHasReader() {
        ...
        fiber {
            expect(channel.hasReaders == false)
            _ = channel.read()
            expect(channel.hasReaders == false)
        ...
        fiber {
            expect(channel.hasReaders == true)
            expect(channel.queue.count == 0)
            channel.write(42)
            expect(channel.hasReaders == false)
    ...
    func testChannelHasWriter() {
        ...
        fiber {
            expect(channel.hasWriters == false)
            channel.write(42)
            expect(channel.hasWriters == false)
        }

        fiber {
            expect(channel.hasWriters == true)
            _ = channel.read()
            expect(channel.hasWriters == false)
        }
    ...
    func testChannelCapacity0() {
        ...
        fiber {
            ...
            expect(channel.canWrite == false)
            expect(channel.canRead == false)
        }
    ...
    func testChannelCapacity1() {
        ...
        fiber {
            expect(channel.isEmpty)
            expect(channel.canWrite == true)
            expect(channel.canRead == false)
            channel.write(1)
            expect(channel.isEmpty == false)
            expect(channel.canWrite == false)
            expect(channel.canRead == true)
            _ = channel.read()
            expect(channel.isEmpty)
            expect(channel.canWrite == true)
            expect(channel.canRead == false)
